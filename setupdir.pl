...
# create run file
    ...
    print WRITEFILE "eval `scram runtime -sh`\n";
    print WRITEFILE "source /cvmfs/projects.cern.ch/intelsw/psxe/linux/all-setup.sh intel64\n";
    print WRITEFILE "if [ ! -f libLHAPDF.so.0 ]; then\n";
    print WRITEFILE "ln -s  /cvmfs/cms.cern.ch/slc6_amd64_gcc530/external/lhapdf/6.1.6-ikhhed2/lib/libLHAPDF.so libLHAPDF.so.0\n";
    print WRITEFILE "fi\n";
    print WRITEFILE "export LD_LIBRARY_PATH=\$PWD:\$LD_LIBRARY_PATH\n";
